...
function JobCategory()
{
    return(
        <div className="job-cat">
          <p className="category-title">Let's help you<span className="different" > choose</span> the<br /> category you want</p>
          <div className="card1">
           <div className="row">
            ...
            <div className="column">
                ...
                <img className="center" src="alternative-medicine-16.png" alt="icon"></img> 
                </div>
                <div className="card-text">
            ...
            <div className="column">
                ...
                <img className="center" src="businessman-16.png" alt="icon"></img> 
                </div>
                <div className="card-text">
            ...
            <div className="column">
                ...
                <img className="center" src="engineering-16.png" alt="icon"></img> 
                </div>
                <div className="card-text">
...
function YourJob()
{
    return(
        <div>
            ...
            <div>
            <p className="list-head">Newest Job<span className="different"> Listing</span></p>
            <p className="list-para">Narrow down your applications and let the most appearing <br /> and matching companies show off</p>
            </div>
            <button className="list-button" >View All Listing</button>
            </div>
            <div className="options">
                <ul className="list-menu">
                    <li className="list-item"><a href="#allcategories">All Categories</a></li>
                    <li className="list-item"><a href="#design">Design</a></li>
                    <li className="list-item"><a href="#technology">Technology</a></li>
